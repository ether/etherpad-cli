...
## Note: this skill is CLI-only

For an Etherpad MCP server, install [`ep_ai_mcp`](https://github.com/ether/ep_ai_mcp) inside an Etherpad instance — it exposes richer changeset-aware tools (authorship, provenance, smart edits) than the HTTP API can offer.
